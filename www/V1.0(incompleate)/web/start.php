<?php
// Hora default de Guadalajara
date_default_timezone_set('America/Mexico_City');
// Inicio de sesion para el sistema
session_start();
// variables para ajuste de hora (principalente en el titulo)
$hour = (int)date('H');
...
<html lang="es-mx">
    <head>
        ...
        <script type="module" src="../node_modules/flowbite-datepicker/js/Datepicker.js"></script>
    ...
    <div class="flex max-w-full h-full">
        <header class="w-auto px-6 h-screen bg-slate-100 shadow-lg  border-r-2 border-gray-200">
                ...
                <div class="grid grid-row self-center ">
                    ...
                    <div class="flex inline-block space-x-2 my-4">
                        ...
                        <a onclick="loadContent('pages/admin/colscopias/main.php');return false" target="_blank" class="  hover:bg-gray-100
                         hover:text-black rounded-lg text-gray-600  font-bold  cursor-pointer text-xl" >Reportes</a>
                    </div>
                    <div class="flex inline-block space-x-2 my-4">
                        <svg width="25px"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="w-full bg-white">
            <div class="flex inline-block bg-white p-4 border-y-2 border-gray-200 mb-5 ">
             <div class="w-full"> <!--Dr. Alan Ortiz-->
                    <div class="text-2xl ">
                        <?php
                        if ($hour >= 5 && $hour < 12) {
                            echo "Buenos días, ";
                        ...
                        if($_SESSION['user_type'] == 'doctor'){
                            echo 'Dr. ' . '<strong>'. $_SESSION['name'] .'</strong>';
                        }else if($_SESSION['user_type'] == 'dev'){
                            echo 'Ing. ' . '<strong>'. $_SESSION['name'] .'</strong>';
                        }else{
                            echo '<strong>'. $_SESSION['name'] .'</strong>';
                        }
                        ?>
                    </div>
                    <div class="text-md text-gray-500">Espero que tengas un bonito día porqué hoy hay 80 pacientes agendados para ti.</div>
                </div>
                <div class="w-auto text-gray-500 inline-block  text-end">
                    <?php echo  $days[$today] . " ".  date("d" ." ". "M" . " " ."Y")?>
                </div>
            </div>

            <div class="max-w-full overflow-auto" id="MainContent">
