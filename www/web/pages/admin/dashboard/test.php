...
<div class="mx-2 ">
    ...
    <!--- CARDSSS--->
    <div class="flex bg-gray-200 flex-none p-2 rounded-lg mx-0 w-full max-w-full space-x-4 overflow-x-auto">

        <div class="bg-white flex-1 w-[25rem] h-[10rem] rounded-lg p-5">
    ...
    <div class="mx-4 space-x-4 my-5 flex w-4/12>
    ...
    <table class="display" id="pacientsTableDs" >
        ...
        <tr>
            <th class="p-3 text-gray-500">Luis corriendo</th>
            <th class="p-3 text-gray-500">Carrera</th>
            <th class="p-3 text-gray-500">15</th>
            <th class="p-3 text-gray-500">C-O-R-R-E-R</th>
            <th class="p-3 text-gray-500">Más rápido</th>
        </tr>
        <tr>
            <th class="p-3 text-gray-500">Ana saltando</th>
            <th class="p-3 text-gray-500">Salto</th>
            <th class="p-3 text-gray-500">12</th>
            <th class="p-3 text-gray-500">S-A-L-T-O</th>
            <th class="p-3 text-gray-500">Llega alto</th>
        </tr>
        <tr>
            <th class="p-3 text-gray-500">Carlos lanzando</th>
            <th class="p-3 text-gray-500">Lanzamiento</th>
            <th class="p-3 text-gray-500">22</th>
            <th class="p-3 text-gray-500">L-A-N-Z-A-R</th>
            <th class="p-3 text-gray-500">Buena fuerza</th>
        </tr>
        <tr>
            <th class="p-3 text-gray-500">Marta girando</th>
            <th class="p-3 text-gray-500">Giro</th>
            <th class="p-3 text-gray-500">18</th>
            <th class="p-3 text-gray-500">G-I-R-A-R</th>
            <th class="p-3 text-gray-500">Buen equilibrio</th>
        </tr>
        <tr>
            <th class="p-3 text-gray-500">José bloqueando</th>
            <th class="p-3 text-gray-500">Bloqueo</th>
            <th class="p-3 text-gray-500">19</th>
            <th class="p-3 text-gray-500">B-L-O-Q-U-E-O</th>
            <th class="p-3 text-gray-500">Mantén posición</th>
        </tr>
        <tr>
            <th class="p-3 text-gray-500">Laura gritando</th>
            <th class="p-3 text-gray-500">Grito</th>
            <th class="p-3 text-gray-500">14</th>
            <th class="p-3 text-gray-500">G-R-I-T-O</th>
            <th class="p-3 text-gray-500">Buena energía</th>
        </tr>
        <tr>
            <th class="p-3 text-gray-500">Pedro respirando</th>
            <th class="p-3 text-gray-500">Respiración</th>
            <th class="p-3 text-gray-500">30</th>
            <th class="p-3 text-gray-500">R-E-S-P-I-R-A-R</th>
            <th class="p-3 text-gray-500">Control</th>
        </tr>
        <tr>
            <th class="p-3 text-gray-500">Sofía concentrada</th>
            <th class="p-3 text-gray-500">Concentración</th>
            <th class="p-3 text-gray-500">25</th>
            <th class="p-3 text-gray-500">C-O-N-C-E-N-T-R-A-C-I-Ó-N</th>
            <th class="p-3 text-gray-500">Muy enfocada</th>
        </tr>
        <tr>
            <th class="p-3 text-gray-500">Marco apoyando</th>
            <th class="p-3 text-gray-500">Apoyo</th>
            <th class="p-3 text-gray-500">17</th>
            <th class="p-3 text-gray-500">A-P-O-Y-O</th>
            <th class="p-3 text-gray-500">Gran espíritu</th>
        </tr>
        </tbody>
    </table>
</div>
