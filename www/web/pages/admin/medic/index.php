...
<div id="modal" class="fixed  inset-0 bg-slate-200 bg-opacity-75 z-50 hidden">
    <div class="flex items-center justify-center h-screen">
        <div class="bg-white p-8 rounded shadow-md w-1/2">
            ...
            <div>
                <div class="w-full grid justify-center mb-5" >
                    <div class="w-11/12  px-3 shadow-lg ">
                        <div class="border-b-2 w-full mt-2">
                            <div class="flex">
                                <nav class="flex w-full  space-x-1 justify-start my-3" aria-label="Global ">
                                    <div id="contenedor_pacient_load_content" class="shadow p-2 hover:bg-gray-30 ">
                                        <button id="pacient_load_content" >Paciente</button>
                                    </div>
                            ...
                            <div  id="pacient_content" class="w-full">
                                <div class="w-full flex items-stretch flex-col  sm:flex-row  mb-2 space-y-1">
                                    <div class=" self-center w-auto space-y-10 grid justify-items-center  ">
                                        ...
                                        <img class="rounded-full " id="img-test"  src="foto/no-photo.jpg" >
                                ...
                                <div>
                                    <div class="p-2">
                                        ...
                                        <div class=" p-3 w-full  grid grid-col w-full gap-3 grid justify-items-end " >
                                            <button class="bg-[#74c8cc] w-5/12  rounded-md p-2 text-white font-semibold place-item-center" onclick="getValues('addressDataForm');return false;">Siguiente</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
